...
namespace Connect4 {
	...
	public class CommProtocol : Game.TurnBasedCommProtocol {
		...
		//Server
		public void sendMove(int targetID, string move, PlayerColor color) { sendString(targetID, MsgType.move, move, color); }
		public void requestMove(int targetID, string board, PlayerColor color) { sendString(targetID, MsgType.boardUpdate, board, color); }
