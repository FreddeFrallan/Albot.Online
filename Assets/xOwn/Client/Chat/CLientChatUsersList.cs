...
namespace ClientUI{
	public class CLientChatUsersList : MonoBehaviour {
		...
		public ClientChatUserListObject userPrefab;
		...
		public void addPlayerToList(string username, int iconNumber, Int64 chatID){
			...
			ClientChatUserListObject newUser = (ClientChatUserListObject)Instantiate (userPrefab, userList);
